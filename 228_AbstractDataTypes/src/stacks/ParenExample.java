...
/**
 * Example using a stack to check whether parentheses and brackets are properly
 * matched.
 */
public class ParenExample {

	/**
	 * Entry point. Displays a few strings and the result of calling checkString().
	 * 
	 * @param args not used
	 */
	...
	/**
	 * Determines whether the parentheses and brackets in the given string are
	 * properly matched.
	 * 
	 * @param text the string to be checked
	 * @return true if the parentheses and brackets in the given string are properly
