...
public class Point implements Comparable<Point> {
	...
	public int compareTo(Point q) {
		...
		if (xORy == true && (this.x < q.x || (this.x == q.x && this.y < q.y))
			...
			// considering this point to be 'less' than the other point; at least one
			// coordinate, x or y, is lower than the other point.
			return -1;
		} else if (this.x == q.x && this.y == q.y) {
			// this point and the other point are considered the same.
			return 0;
		} else {
			// other point is 'bigger' than this point; one or both coordinates are larger
			// than this point.
			return 1;
		}
	}
